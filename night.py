...
class Night(Router):
    ...
    def _match_prefixed_dynamic_fast(self, path: str, method: str):
        index = self._dynamic_prefix_index.get(method)
        if not index:
            return None
    ...
    async def _call_route(self, route: Route, req: Request, params: t.Any) -> Response:
        plan = route._night_plan
        fn = route.endpoint
